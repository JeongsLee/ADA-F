...
checkpoint_filepath = "./transformer/checkpoint"
...
np.savetxt('./loss_tf.txt', loss, delimiter=',')
np.savetxt('./accuracy_tf.txt', accuracy, delimiter=',')
np.savetxt('./val_loss_tf.txt', val_loss, delimiter=',')
np.savetxt('./val_accuracy_tf.txt', val_accuracy, delimiter=',')
